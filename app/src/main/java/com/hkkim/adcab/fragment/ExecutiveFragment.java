...
import com.hkkim.adcab.viewmodel.ExecutiveViewModel;
...
public class ExecutiveFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        RecyclerView recyclerView = view.findViewById(R.id.recyclerView_executive);
...
//        mViewModel = new ViewModelProvider(this).get(ChristianViewModel.class);
        ...
        mChristians.clear();
        for (int i=0; i<10; ++i) {
            Christian data = new Christian(String.format("임원-%d", i+1), "어머니회", "2교구", "22구역", "010-1111-2222");
