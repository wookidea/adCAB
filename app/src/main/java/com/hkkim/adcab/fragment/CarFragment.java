...
import com.hkkim.adcab.viewmodel.CarViewModel;
...
public class CarFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        RecyclerView recyclerView = view.findViewById(R.id.recyclerView_car);
...
//        mViewModel = new ViewModelProvider(this).get(ChristianViewModel.class);
        ...
        mChristians.clear();
        for (int i=0; i<10; ++i) {
            Christian data = new Christian(String.format("차량-%d", i+1), "봉사회", "5교구", "52구역", "010-1111-2222");
