...
import com.hkkim.adcab.viewmodel.PreacherViewModel;
import com.hkkim.adcab.R;

import java.util.ArrayList;

public class PreacherFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.preacher_fragment, container, false);

        RecyclerView recyclerView = view.findViewById(R.id.recyclerView_preacher);
...
//        mViewModel = new ViewModelProvider(this).get(ChristianViewModel.class);
        ...
        mChristians.clear();
        for (int i=0; i<10; ++i) {
            Christian data = new Christian(String.format("전도인-%d", i+1), "봉사회", "5교구", "52구역", "010-1111-2222");
