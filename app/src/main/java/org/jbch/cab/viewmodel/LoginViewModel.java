...
public class LoginViewModel extends ViewModel {
    ...
    public void login(String url, String protocol, String username, String password) {
        // can be launched in a separate asynchronous job
        Result<LoggedInUser> result = loginRepository.login(url, protocol, username, password);
